...
public class Derek1 {
    ...
    // Here I'm defining a new class (Blueprint) named defaultPackage.HelloWorld
...
// defaultPackage.HelloWorld is just what you named your program. That allows you to reference it later
// { is the opening brace that surrounds the code used by defaultPackage.HelloWorld
